...
st.subheader("Mirage Shrestha")
st.write('\n\n')

# Use cache_data instead of cache
@st.cache_data
def get_all_data():
    root = "Datasets/"
...
def training_step(data, vectorizer):
    ...
    training_result = [int(data[1]) for data in data]  # Convert labels to integers
...
def print_result(result):
    ...
    print_text = "Positive" if analysis_result[0] == 1 else "Negative"  # Ensure you're using integers
